...
{
    public class CustomTerminalView : Control
    {
        ...
        public static readonly DirectProperty<CustomTerminalView, bool> IsAlternateBufferProperty =
            AvaloniaProperty.RegisterDirect<CustomTerminalView, bool>(
                nameof(IsAlternateBuffer),
                o => o.IsAlternateBuffer);

        public static readonly DirectProperty<CustomTerminalView, int> BufferSizeProperty =
            AvaloniaProperty.RegisterDirect<CustomTerminalView, int>(
                nameof(BufferSize),
                o => o._bufferSize,
                (o, v) => o._bufferSize = v);

        public static readonly DirectProperty<CustomTerminalView, int> ViewportYProperty =
            AvaloniaProperty.RegisterDirect<CustomTerminalView, int>(
                nameof(ViewportY),
                o => o.ViewportY,
                (o, v) => o.ViewportY = v);

        public static readonly DirectProperty<CustomTerminalView, int> MaxScrollbackProperty =
            AvaloniaProperty.RegisterDirect<CustomTerminalView, int>(
                nameof(MaxScrollback),
                o => o.MaxScrollback);

        public static readonly DirectProperty<CustomTerminalView, int> ViewportLinesProperty =
            AvaloniaProperty.RegisterDirect<CustomTerminalView, int>(
                nameof(ViewportLines),
                o => o.ViewportLines);

        public static readonly StyledProperty<FontFamily> FontFamilyProperty =
            AvaloniaProperty.Register<CustomTerminalView, FontFamily>(
                nameof(FontFamily),
                defaultValue: FontFamily.Default);

        public static readonly StyledProperty<double> FontSizeProperty =
            AvaloniaProperty.Register<CustomTerminalView, double>(
                nameof(FontSize),
                defaultValue: 12);

        public static readonly StyledProperty<FontStyle> FontStyleProperty =
            AvaloniaProperty.Register<CustomTerminalView, FontStyle>(
                nameof(FontStyle),
                defaultValue: FontStyle.Normal);

        public static readonly StyledProperty<FontWeight> FontWeightProperty =
            AvaloniaProperty.Register<CustomTerminalView, FontWeight>(
                nameof(FontWeight),
                defaultValue: FontWeight.Normal);

        public static readonly StyledProperty<TextDecorationLocation?> TextDecorationsProperty =
            AvaloniaProperty.Register<CustomTerminalView, TextDecorationLocation?>(
                nameof(TextDecorations),
                defaultValue: null);

        public static readonly StyledProperty<IBrush> ForegroundProperty =
            AvaloniaProperty.Register<CustomTerminalView, IBrush>(
                nameof(Foreground),
        ...
        public static readonly StyledProperty<string> ProcessProperty =
            AvaloniaProperty.Register<CustomTerminalView, string>(
                nameof(Process),
        ...
        public static readonly RoutedEvent<ProcessExitedEventArgs> ProcessExitedEvent =
            RoutedEvent.Register<CustomTerminalView, ProcessExitedEventArgs>(
        ...
        public static readonly RoutedEvent<TitleChangedEventArgs> TitleChangedEvent =
            RoutedEvent.Register<CustomTerminalView, TitleChangedEventArgs>(
                nameof(TitleChanged),
                RoutingStrategies.Bubble);
        ...
        public static readonly RoutedEvent<WindowMovedEventArgs> WindowMovedEvent =
            RoutedEvent.Register<CustomTerminalView, WindowMovedEventArgs>(
                nameof(WindowMoved),
                RoutingStrategies.Bubble);
        ...
        public static readonly RoutedEvent<WindowResizedEventArgs> WindowResizedEvent =
            RoutedEvent.Register<CustomTerminalView, WindowResizedEventArgs>(
        ...
        public static readonly RoutedEvent<RoutedEventArgs> WindowMinimizedEvent =
            RoutedEvent.Register<CustomTerminalView, RoutedEventArgs>(
        ...
        public static readonly RoutedEvent<WindowInfoRequestedEventArgs> WindowInfoRequestedEvent =
            RoutedEvent.Register<CustomTerminalView, WindowInfoRequestedEventArgs>(
        ...
        static CustomTerminalView()
        {
            AffectsRender<CustomTerminalView>(
                FontFamilyProperty,
                FontSizeProperty,
                FontStyleProperty,
                FontWeightProperty,
            ...
            AffectsMeasure<CustomTerminalView>(
                FontFamilyProperty,
                FontSizeProperty,
                FontStyleProperty,
                FontWeightProperty,
            ...
            FocusableProperty.OverrideDefaultValue<CustomTerminalView>(true);
        }

#pragma warning disable CS8618 // Non-nullable field must contain a non-null value when exiting constructor. Consider adding the 'required' modifier or declaring as nullable.
        public CustomTerminalView()
...
#pragma warning restore CS0618 // Type or member is obsolete
        ...
        protected override async void OnKeyDown(KeyEventArgs e)
        {
            ...
            {
                Debug.WriteLine($"[CustomTerminalView] No PTY connection");
                base.OnKeyDown(e);
                return;
            }
        ...
        protected override async void OnTextInput(TextInputEventArgs e)
        {
            ...
            if (!IsFocused)
            {
                Debug.WriteLine($"[CustomTerminalView] OnTextInput: Not focused, passing to base");
                base.OnTextInput(e);
                return;
            }
            ...
            {
                Debug.WriteLine($"[CustomTerminalView] OnTextInput: No PTY or empty text");
                base.OnTextInput(e);
                return;
            }
            ...
            {
                Debug.WriteLine($"[CustomTerminalView] OnTextInput: Win32 input mode, skipping");
                return;
            }
            ...
            try
            {
                Debug.WriteLine($"[CustomTerminalView] OnTextInput: Sending '{e.Text}' to PTY");
        ...
        protected override async void OnGotFocus(GotFocusEventArgs e)
        {
            ...
            Debug.WriteLine($"[CustomTerminalView] OnGotFocus: Source={e.Source?.GetType().Name}");
        ...
        protected override async void OnLostFocus(RoutedEventArgs e)
        {
            ...
            Debug.WriteLine($"[CustomTerminalView] OnLostFocus");
        ...
        public override void Render(DrawingContext context)
        {
            ...
            {
                Debug.WriteLine($"[CustomTerminalView] Render error: {ex.Message}");
            }
        }
        ...
        private string GenerateWin32InputSequence(KeyEventArgs e, bool isKeyDown)
        {
            ...
            if (vk == 0)
            {
                Debug.WriteLine($"[CustomTerminalView] Win32: No VK for Key={e.Key}");
                return string.Empty;
            }
